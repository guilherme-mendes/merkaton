...
class ProdutosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create produto" do
    assert_difference('Produto.count') do
      post produtos_url, params: { produto: { descrição: @produto.descrição, nome: @produto.nome, preço: @produto.preço } }
    end
  ...
  test "should update produto" do
    patch produto_url(@produto), params: { produto: { descrição: @produto.descrição, nome: @produto.nome, preço: @produto.preço } }
