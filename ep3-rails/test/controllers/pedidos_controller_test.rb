...
class PedidosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pedido" do
    assert_difference('Pedido.count') do
      post pedidos_url, params: { pedido: { cidade: @pedido.cidade, endereco: @pedido.endereco, estado: @pedido.estado } }
    end
  ...
  test "should update pedido" do
    patch pedido_url(@pedido), params: { pedido: { cidade: @pedido.cidade, endereco: @pedido.endereco, estado: @pedido.estado } }
